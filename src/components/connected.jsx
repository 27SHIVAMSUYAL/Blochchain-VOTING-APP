    ...
    return (
        <div className="connected-container  " >
            ...
            <div className=" grid grid-cols-2 gap-2 ">
                ...
                <div className=" grid grid-cols-1">
                    ...
                    <button onClick={async () => {
                        ...
                        can = parseInt(can);
                        setNames(await props.displayCandidates(can));
                        console.log("hello");
                        console.log(names);
                        setElectionNUMBER(can);
                    }} className="bg-blue-300 rounded-lg  hover:bg-green-500 hover:font-bold"> Enter Election Number</button>
                        ...
                        {names.length > 0 ? (
                            names.map((data, index) => {
                                return <div className="grid grid-cols-2">
                                    ...
                                    <div> <button onClick={() => { props.vote(ElectionNumber, index) }} className=" w-32 my-1 rounded-md bg-red-400 font-medium hover:bg-green-400 hover:font-bold"> vote candidate</button> </div>
                                </div>
                            }
                            )) : (<p>no candidates avaliable</p>)
                        }
                        {console.log(names)/* {names of candidates fetched and displayed here end */}
            ...
            <div className="m-2">
                ...
                <input id="resultid" placeholder="enter election number"></input>
            ...
            <div className=" grid grid-cols-3">
                ...
                <button onClick={() => { let enumber = document.getElementById("enumber").value; enumber = parseInt(enumber); props.add(enumber, newCandidate); document.getElementById("input").value = ""; }} className=" rounded bg-amber-200 mx-2 hover:bg-green-500 hover:font-bold"> Add New Candidate</button>
